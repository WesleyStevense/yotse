...
import pandas as pd
import numpy as np
from netsquid_simulationtools.repchain_data_process import process_data_duration, process_data_bb84, \
            ...
            for filename in subfolder_files:
                if filename.endswith(".pickle"):
                    ...
                    new_processed_data = process_repchain_dataframe_holder(
                        ...
                        processing_functions=[process_data_duration, process_data_bb84])
...
if __name__ == "__main__":
    ...
    baseline_parameter_file = "ae_baseline_params.yaml"
    ...
    output_for_stopos["sk_rate"] = csv_output["sk_rate"]

    for parameter in param_list:
        output_for_stopos[parameter] = csv_output[parameter]
    #UNCOMMENT FOLLOWING LINES FOR COST FUNCTION:
